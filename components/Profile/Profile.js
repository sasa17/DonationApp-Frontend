...
class Profile extends Component {
  ...
  render() {
    ...
    const donations = profileStore.profile.past_donations
      ...
      .reverse();
    const initials =
      profileStore.profile.first_name[0] + profileStore.profile.last_name[0];
    return (
      <Container style={styles.authContainer}>
        ...
        <Card transparent>
          <CardItem style={{ backgroundColor: "snow" }}>
        ...
        <Content>
          <Container style={styles.authContainer}>{donations}</Container>
        </Content>
        <LogoutButton />
      </Container>
    );
